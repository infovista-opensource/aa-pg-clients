...
![Static Badge](https://img.shields.io/badge/Postgres_Clients-16.10-blue) ![Static Badge](https://img.shields.io/badge/alpine-3.22-brightgreen)



Collection of tools PostgreSQL clients. Available tools:

* [pg_amcheck](https://www.postgresql.org/docs/16/app-pgamcheck.html)
...
* [pg_receivewal](https://www.postgresql.org/docs/16/app-pgreceivewal.html)
* [pg_recvlogical](https://www.postgresql.org/docs/16/app-pgrecvlogical.html)
...
i.e. : `piccio/aa-pg-clients`:**16-r0**
